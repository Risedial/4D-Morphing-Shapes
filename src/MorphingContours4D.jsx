...
try {
  ...
  // Proper MIME type detection with correct fallback
  let mimeType;
  let fileExtension;
  ...
  // Promise-based approach for more reliable frame timing
  const renderFrame = () => {
    return new Promise((resolve) => {
      ...
      // Small delay to ensure the frame is captured by the stream
      ...
      <div className="space-y-3">
        ...
        <div className="text-xs text-gray-500 space-y-1">
          {/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ? (
            <>
              <p>* <strong>Mobile:</strong> 1080p WebM video</p>
            ...
            <>
              <p>* <strong>Desktop:</strong> 1440p WebM video</p>
